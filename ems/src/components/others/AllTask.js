  ...
  return (
    <div className='bg-[#1c1c1c] p-5 rounded mt-5'>
        ...
        {userData.map(function(elem,idx){
            ...
            return <div key={idx} className='bg-transparent border-2 border-emerald-500 mb-2 py-2 px-4 flex justify-between'>
            <h2 className='text-lg font-medium w-1/5'>{elem.firstName}</h2>
            <h3 className='text-lg font-medium w-1/5 text-blue-600'>{elem.taskCount.newTask}</h3>
            <h5 className='text-lg font-medium w-1/5 text-purple-600'>{elem.taskCount.active}</h5>
